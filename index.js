...
document.querySelector(":root").style.setProperty("--customColor", "#2E8B57");
...
new TypeIt("#type1", {
  ...
  .type("QA Engineer", { delay: 400 })
  .pause(500)
  .delete(15)
  .type("Automation Engineer", { delay: 400 })
  .pause(500)
  .delete(20)
  .type("Practical Software Engineer", { delay: 400 })
  .pause(500)
  .delete(30)
  .go();
